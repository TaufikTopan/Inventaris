    ...
    <div class="panel panel-primary">
        ...
        <?php
            if (isset($_POST['simpan'])) {
                ...
                $sql_pengembalian = "UPDATE peminjaman_baru SET tanggal_kembali = '$tgl_kembali', status_peminjaman='2' WHERE  id_peminjaman='$id_peminjaman'";
