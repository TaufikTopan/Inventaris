<?php
    $sql = "SELECT max(id_peminjaman) as maxKode FROM peminjaman_baru";
        ...
        <div class="panel panel-primary">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_pegawai" id="" class="form-control">
                                ...
                                <?php
                                    $sql_pegawai = "SELECT * FROM pegawai_baru";
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_inventaris" id="" class="form-control">
                                ...
                                <?php
                                    $sql_inventaris = "SELECT * FROM inventaris_baru";
            ...
            <?php
                if (isset($_POST['simpan'])) {
                    ...
                    $jumlah = $_POST['jumlah'];
                    $sql_peminjaman = "INSERT INTO peminjaman_baru SET
                    id_peminjaman = '$id_peminjaman',
                    id_pegawai = '$id_pegawai',
                    status_peminjaman = '0'";
                    $query_input = mysqli_query($koneksi, $sql_peminjaman);
                    if ($query_input) {
                        $detail_pinjam = "INSERT INTO detail_pinjam_baru SET
                        jumlah = '$jumlah',
            ...
            <div class="panel-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            $hari = date('d-m-Y');
                            $d_peminjaman = "SELECT *, detail_pinjam_baru.jumlah as jml FROM detail_pinjam_baru LEFT JOIN peminjaman_baru ON peminjaman_baru.id_peminjaman = detail_pinjam_baru.id_peminjaman LEFT JOIN inventaris_baru ON inventaris_baru.id_inventaris = detail_pinjam_baru.id_inventaris LEFT JOIN pegawai_baru ON pegawai_baru.id_pegawai = peminjaman_baru.id_pegawai";
